...
func redeemCodeFromServiceBase(rc *service.RedeemCode) RedeemCode {
	...
	// For admin_balance/admin_concurrency types (concurrency kept for backward compat),
	// include notes so users can see why they were charged or credited by admin
