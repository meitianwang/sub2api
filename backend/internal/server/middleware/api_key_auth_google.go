...
// APIKeyAuthGoogle is a Google-style API key auth middleware.
//
// It returns Google-style errors:
// {"error":{"code":401,"message":"...","status":"UNAUTHENTICATED"}}
//
// Intended for Gemini native endpoints (/v1beta) to match Gemini SDK expectations.
