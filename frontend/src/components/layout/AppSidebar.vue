...
const userNavItems = computed((): NavItem[] => {
  const items: NavItem[] = [
    ...
    { path: '/payment', label: t('nav.payment') || '充值', icon: CreditCardIcon, hideInSimpleMode: true },
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/payment-orders', label: t('nav.paymentOrders') || '支付订单', icon: CreditCardIcon, hideInSimpleMode: true },
    { path: '/admin/payment-config', label: t('nav.paymentConfig') || '支付配置', icon: CogIcon, hideInSimpleMode: true },
