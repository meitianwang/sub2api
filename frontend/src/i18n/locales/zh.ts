export default {
  ...
  home: {
    ...
    hero: {
      title: '一个 API Key，调用所有 AI 模型。',
      subtitle: 'Claude · GPT · Gemini · 共 {count} 个模型，按 token 计费，无需订阅。',
      subtitleFallback: 'Claude · GPT · Gemini · 按 token 计费，无需订阅。'
    },

    curl: {
      title: '发起第一次调用',
      description: '一个 API Key 即可调用任意支持的模型。',
      copy: '复制',
      copied: '已复制'
    },
    ...
    values: {
      routing: '多账号路由，故障自动切换。',
      billing: '按 token 计费 —— 只为使用付费。',
      compat: '兼容 Claude Code、OpenAI SDK、Gemini CLI。'
    },
  ...
  terms: {
    title: '服务条款',
    effectiveDate: '生效日期：2026 年 4 月 29 日',
    intro: {
      welcome: '欢迎使用 AIInterface（以下简称"本平台"或"我们"）。本服务条款（以下简称"本条款"）是您与 AIInterface 之间就您使用本平台所提供的 API 网关、模型聚合及相关工具（以下统称"服务"）所订立的协议。当您注册账号、充值或调用服务时，即视为您已阅读并同意本条款的全部内容。如您不同意，请勿使用本服务。',
      notTargeted: '您应自行确保您对本服务的使用符合您所在地的法律法规；如您所在地的法律禁止或限制您使用本服务，您应立即停止使用。您因违反所在地法律使用本服务所产生的一切后果，由您自行承担。',
    },
    A: {
      title: 'A. 服务说明',
      p1: '本平台聚合 Claude、GPT、Gemini 等第三方 AI 模型，通过统一 API 协议为您提供模型路由、计费、密钥管理等能力。本平台不是上游模型的提供方，模型本身的能力、可用性及输出内容由其原厂商决定。',
      p2: '您可自行选择是否调用通过本平台暴露的第三方模型功能，本平台不对第三方功能本身负责。如您向本平台反馈意见，本平台可自行决定是否采纳，且无须对您承担任何义务。',
    },
    B: {
      title: 'B. 账户与注册',
      p1: '您需通过有效邮箱注册账号。您应妥善保管账号、密码与 API Key，不得将凭证转售、外借或以任何形式提供给未授权的第三方。因您自身原因导致凭证泄漏所产生的一切费用与后果，由您自行承担。',
      p2: '如您发现账号或 API Key 存在被盗用、被攻击或异常调用情况，应立即重置密钥并通过下文联系方式通知本平台。',
    },
    C: {
      title: 'C. 充值与计费',
      p1: '本平台采用预付费 + 按 token 计费模式。您需先向账号充值余额，调用服务时按所用模型的实时价格扣减余额。各模型的输入 / 输出单价以"模型与定价"页面公示为准，本平台保留根据上游成本变动调整定价的权利，调整将提前在站内公告。',
      p2: '您应及时支付您账号下产生的所有费用。余额耗尽时，本平台有权暂停您对服务的访问，直至您完成续费。您对本平台支付的款项不包含因您使用服务可能产生的任何税费、关税或类似费用，相关税费由您自行承担。',
    },
    D: {
      title: 'D. 退款政策',
      items: {
        scope: { label: '退款范围', body: '因您自身原因（包括但不限于不再需要服务、使用计划调整、对模型效果不满意等）申请退款的，本平台有权拒绝。因本平台原因导致服务长时间不可用，且不可用期间您账户持续存在余额的，可申请按比例退款。' },
        method: { label: '退款方式', body: '充值后 90 天内的退款，将原路退回至原支付渠道；超过 90 天的，因支付渠道无法原路退回，您需另行提供与付款人身份一致的收款方式。' },
        review: { label: '审核与材料', body: '所有退款申请均需经本平台审核。您需提交：(a) 原始支付凭证（支付截图、订单号等）；(b) 与付款账户一致的身份信息；(c) 无法原路退回时，与付款人身份一致的收款账户信息。本平台有权要求补充额外材料。' },
        antiFraud: { label: '反欺诈', body: '为防止欺诈、洗钱及滥用补贴等行为，本平台保留对退款申请进行额外审查的权利，包括但不限于核验付款人与收款人的身份一致性。如发现申请存在欺诈嫌疑，本平台有权拒绝退款并暂停相关账号。' },
        finalInterpretation: { label: '最终解释权', body: '本平台保留对退款政策的最终解释权，并有权拒绝不符合退款条件的申请。' },
      },
    },
    E: {
      title: 'E. 使用规范',
      intro: '您不得（且不得协助第三方）通过本平台从事下列行为：',
      list: {
        laws: '违反任何对您具有约束力的法律法规或损害公共利益；',
        harmfulContent: '生成、传播涉及暴力、色情、恐怖、歧视、欺诈、虚假信息等违法或有害内容；',
        reverseEngineering: '逆向工程、抓取或复制本平台的服务实现；',
        compete: '构建与本平台直接竞争的同类聚合服务，或转售本平台的接口；',
        attack: '对本平台或上游服务发起拒绝服务攻击、绕过限流或其他恶意调用；',
        ip: '侵犯他人知识产权、隐私权、名誉权或其他合法权益；',
        other: '其他可能损害本平台、其他用户或上游模型提供方利益的行为。',
      },
      outputDisclaimer: '您应自行评估模型输出是否适合您的用例，并在必要时进行人工复核。模型输出可能包含不准确、过时或具有偏见的信息，您不应在未经核实的情况下将其作为事实依据，亦不应将其用于医疗、法律、金融等可能影响人身或财产安全的关键决策。',
    },
    F: {
      title: 'F. 知识产权',
      p1: '在适用法律允许的范围内：您保留对您提交至服务的输入（"输入"）的全部权利；您拥有服务针对您输入生成的输出（"输出"）。本平台不会使用您的输入或输出训练任何模型。上述权利分配以您不违反本条款为前提。',
      p2: '本平台的代码、商标、品牌标识、文档及网站设计等知识产权归本平台所有，除本条款明确授权外，您不得复制、修改或用于其他用途。',
    },
    G: {
      title: 'G. 隐私',
      p1: '本平台仅在为您提供服务所必需的范围内收集和处理您的账户信息、调用日志与计费数据。您的请求与响应内容不会被用于模型训练，也不会向无关第三方披露，但本平台可能将必要信息（如请求体、模型 ID）转发给上游模型提供方以完成调用，此类转发受上游服务自身的隐私政策约束。',
    },
    H: {
      title: 'H. 服务可用性与免责',
      p1: '本平台以"现状"和"可用"方式提供服务，不就以下事项作出任何明示或暗示的保证：(a) 服务或输出绝对准确、完整、无错误或不会中断；(b) 任何第三方模型或接口的可用性、质量或合规性；(c) 服务能够满足您的特定业务需求。',
      p2: '因下列情形导致的服务中断或异常，本平台不承担责任：(a) 不可抗力（如自然灾害、战争、政府行为）；(b) 上游模型提供方限流、封禁、调价或停止服务；(c) 您使用的网络运营商、设备或浏览器问题；(d) 您违反本条款导致的暂停。',
    },
    I: {
      title: 'I. 责任限制',
      p1: '在适用法律允许的最大范围内，本平台及其关联方对因本条款或您使用服务而产生的任何间接的、附带的、特殊的、惩罚性的损失（包括但不限于利润损失、业务损失、数据丢失或商誉损失）不承担责任。无论基于何种原因，本平台对您的累计赔偿责任总额不超过您在最近 12 个月内为服务实际支付的费用金额。',
    },
    J: {
      title: 'J. 终止与暂停',
      p1: '您可随时停止使用服务并注销账号；账号注销后剩余余额按"退款政策"处理。如您严重违反本条款（包括但不限于"使用规范"中列出的禁止行为），本平台有权立即暂停或终止您对服务的访问，并保留追究您法律责任的权利。',
      p2: '在以下情形下，本平台亦可暂停您对服务的访问：(a) 本平台合理判断您的使用对服务或其他用户构成风险；(b) 上游服务因任何原因停止向本平台提供能力；(c) 本平台向您提供服务被适用法律禁止。',
    },
    K: {
      title: 'K. 条款修改',
      p1: '本平台可不时更新本条款。修改后的条款将在本页面发布，重大修改将提前 30 天在站内公告或通过您预留的邮箱通知您。修改后的条款发布生效之日起，您继续使用服务即视为接受修改后的条款。如您不接受修改，应停止使用并申请注销账号。',
    },
    L: {
      title: 'L. 适用法律与争议解决',
      p1: '本条款的订立、效力、解释、履行及争议解决均适用新加坡共和国法律（Singapore Law），不考虑其法律冲突原则。',
      p2: '如您与本平台就本条款或本服务产生任何争议、索赔或纠纷，双方应首先尝试通过友好协商解决。协商不成的，争议应提交至新加坡国际仲裁中心（Singapore International Arbitration Centre，SIAC），按照其届时有效的仲裁规则在新加坡进行最终的、有约束力的仲裁。仲裁庭由一名仲裁员组成，仲裁语言为英语（双方另行书面同意以中文进行的除外）。仲裁裁决为终局裁决，对双方均具有约束力。',
      p3: '在适用法律允许的最大范围内，您同意放弃以集体诉讼、合并诉讼或代表他人的形式对本平台主张权利；任何争议仅可基于您个人名义提出。',
    },
    M: {
      title: 'M. 联系方式',
      p1: '如您对本条款有任何疑问，或需提交退款、违规举报、隐私相关请求，请通过以下方式联系我们：',
      email: '邮箱',
    },
    footer: {
      home: '首页',
  ...
  usagePolicy: {
    ...
    effectiveDate: '生效日期：2026 年 4 月 29 日',
    intro: {
      p1: '本使用政策（"Acceptable Use Policy"，以下简称"AUP"）适用于通过任何方式使用 AIInterface 服务的所有用户，包括直接调用以及通过授权第三方分发或经销访问的用户。本政策与服务条款共同生效，用以明确哪些行为不被允许。我们会随技术演进与已识别的新风险持续更新本政策。',
      p2: '如您违反本政策，本平台有权立即暂停或终止您的账户访问，并保留追究相应责任的权利。',
    },
    general: {
      title: '通用使用标准',
      intro: '以下标准适用于所有用户和所有用例。',
      items: {
        laws: {
          title: '法律合规',
          body: '不得使用本服务从事、协助或鼓励违反任何对您具有约束力的法律的活动，包括但不限于虐待、剥削或伤害儿童的行为。',
        },
        criticalInfra: {
          title: '关键基础设施',
          body: '不得使用本服务伤害、破坏或扰乱电信、医疗、能源、交通、供水、金融或选举等关键基础设施的技术系统。',
        },
        cyberSecurity: {
          title: '计算机与网络安全',
          body: '不得使用本服务开发、传播或部署恶意软件，或以其他方式破坏、干扰、未授权访问或控制任何计算机系统、网络或在线账户。',
        },
        weapons: {
          title: '武器与高破坏力技术',
          body: '不得使用本服务设计、开发、制造或测试核武器、生物武器、化学武器、放射性武器、自主武器系统、军用级网络攻击工具或具有大规模杀伤潜力的其他技术。',
        },
        violence: {
          title: '暴力与仇恨',
          body: '不得使用本服务煽动、宣传、美化针对个人或群体的极端暴力，或基于身份特征（种族、民族、宗教、性别、性取向、残障等）的仇恨内容。',
        },
        privacy: {
          title: '隐私与身份',
          body: '不得使用本服务从事跟踪、骚扰、欺凌或侵犯他人隐私的行为，包括但不限于在私人或受限场所进行人脸识别、利用泄露的个人信息进行身份盗用、未经同意地汇总他人个人数据。',
        },
        childSafety: {
          title: '儿童安全',
          body: '不得使用本服务创建、获取或传播任何形式的儿童性虐待材料（CSAM），或宣扬、美化对未成年人的性剥削或虐待。这是绝对禁令——违反者将被立即封禁，本平台并按法律要求向相关执法机构报告。',
        },
        psychological: {
          title: '心理与情感伤害',
          body: '不得使用本服务自动生成或传播旨在造成心理或情感伤害的内容，包括鼓励自残或自杀，或针对特定个人的有组织骚扰。',
        },
        misinformation: {
          title: '错误信息',
          body: '不得使用本服务大规模生成或传播虚假、误导或欺骗性内容，特别是涉及公共卫生、选举、司法等公共领域的此类内容。',
        },
        politics: {
          title: '政治竞选与民主进程',
          body: '不得使用本服务进行政治竞选、政党宣传，或制作旨在大规模操纵投票行为的针对性内容（包括有政治倾向的个性化推送、自动化游说聊天机器人、选民压制材料等）。',
        },
        surveillance: {
          title: '监视与执法滥用',
          body: '不得使用本服务进行预测性警务、自动化量刑或拘留决定、大规模监视，或其他被法律或国际人权标准禁止的执法用途。',
        },
        fraud: {
          title: '欺诈与掠夺性行为',
          intro: '不得使用本服务：',
          list: {
            fraudulent: '创建欺诈性、虚假或冒充他人身份的内容；',
            predatory: '进行赌博、发薪日贷款、高利贷等具有掠夺性的金融活动；',
            spam: '生成或传播垃圾邮件、钓鱼信息、电信诈骗剧本；',
            deception: '从事其他以欺骗为核心的非法行为。',
          },
        },
        platformAbuse: {
          title: '平台滥用',
          intro: '不得：',
          list: {
            bypass: '绕过、伪造或人为规避本平台的限流、配额或鉴权机制；',
            multiAccount: '通过虚假身份注册多个账户以重复领取充值优惠或试用额度；',
            shareKey: '转售、共享或外借您的 API Key 给未授权的第三方；',
            scrape: '抓取、爬取或大规模复制本平台的接口、文档或界面以构建竞品；',
            extract: '尝试提取、复制或反向工程任何上游模型的权重或训练数据。',
          },
        },
        sexual: {
          title: '性露骨内容',
          body: '不得使用本服务生成色情或具有露骨性目的的内容（无论文本、图像还是音视频）。但合法的性与生殖健康教育、医学、科学研究或艺术语境下的使用不受此限。',
        },
      },
    },
    highRisk: {
      title: '高风险用例',
      intro: '下列领域对个人或公共福祉有重大影响。如您将本服务用于这些领域，必须实施以下额外保护措施：',
      humanInLoop: {
        label: '人在回路（Human-in-the-loop）',
        body: '在向最终用户提供建议、推荐或主观判断之前，必须由具备相应资质的专业人员审查模型输出。您和您的组织对最终结果的准确性与适当性负责。',
      },
      disclosure: {
        label: '披露',
        body: '如模型输出会直接呈现给最终用户，您必须明确告知用户内容由 AI 协助生成；至少在每次会话开始时披露一次。',
      },
      domainsTitle: '高风险领域包括但不限于：',
      domains: {
        legal: {
          label: '法律',
          body: '法律解释、法律建议、有法律效力的决策。',
        },
        healthcare: {
          label: '医疗',
          body: '诊断、治疗建议、用药指导、心理健康干预（一般性的睡眠、运动、营养建议不属于此类）。',
        },
        insurance: {
          label: '保险',
          body: '核保、理赔决定、保单设计。',
        ...
        employment: {
          label: '就业与住房',
          body: '简历筛选、招聘评估、租赁审核、住房贷款决定。',
        },
        academic: {
          label: '学术与认证',
          body: '升学考试评估、专业资格考试、教育机构认证。',
        },
        media: {
          label: '媒体与新闻',
          body: '自动生成对外发布的新闻、评论或专业新闻内容。',
        },
      },
    },
    transparency: {
      ...
      chatbots: {
        title: '聊天机器人披露',
        body: '任何面向终端用户的聊天机器人或交互式 AI 代理必须告知用户其对话方为 AI；至少在每次会话开始时披露一次。',
      },
      agents: {
        title: 'Agent / 自主代理用例',
        body: '即使您构建的是自主代理（Agent）系统，本政策的所有条款仍然适用。Agent 越权或在隔离环境外执行操作所产生的后果，由您承担责任。',
      },
      minors: {
        title: '未成年人',
        body: '如您的产品面向未成年人或可能被未成年人访问，您应建立适当的年龄筛选与内容分级机制，并对未成年人接触的输出承担更高的审慎义务。',
      },
    },
    upstream: {
      title: '上游模型政策',
      p1: '本平台是模型聚合网关。您通过本平台调用的每一个上游模型（Anthropic Claude、OpenAI GPT、Google Gemini 等）均有其各自的使用政策。您的调用必须同时遵守上游服务的使用政策；上游对您使用的任何限制（包括限流、内容过滤、合规要求）会通过本平台传导至您。',
      p2: '如上游模型提供方因您违反其政策而限制本平台的能力，本平台有权将相应限制传递给您，包括但不限于暂停您对受影响模型的访问。',
    },
    consequences: {
      title: '违反政策的后果',
      p1: '如本平台合理认定您违反本政策，我们可采取以下任一或多项措施：',
      list: {
        warning: '警告并要求您限期整改；',
        suspend: '临时或永久暂停您的账户；',
        terminate: '终止您对本服务的访问；',
        refundDeny: '拒绝相关账户的余额退款（如违反系欺诈性质）；',
        lawEnforcement: '配合执法机构调查并提供必要信息；',
        damages: '追究您因此给本平台或他人造成的损失。',
      },
      p2: '我们对何时及如何采取上述措施保留自由裁量权。',
    },
    revisions: {
      title: '修订',
      p1: '本平台可不时更新本政策以应对新出现的风险。重大修订将在站内公告并在 30 天后生效；非重大修订（如表述润色、补充示例）发布即生效。您持续使用服务即视为接受最新政策。',
    },
    footer: {
      copyright: '保留所有权利。',
      home: '首页',
  ...
  supportedRegions: {
    title: '支持的国家和地区',
    effectiveDate: '生效日期：2026 年 4 月 29 日',
    intro: 'AIInterface 是一项全球性的 API 网关服务，运营主体受新加坡共和国法律管辖（详见服务条款 L 节）。在适用法律允许的最大范围内，我们向全球开发者和企业提供商业 API 访问。',
    general: {
      title: '总体可用性',
      body: '我们以全球可用为默认前提，但不向以下章节列出的受限地区提供服务。"受限"包括完全无法注册、无法充值、调用持续受限或本平台依据法律要求暂停服务等情形。',
    },
    restricted: {
      title: '受限地区',
      intro: '我们不向以下地区的居民、组织或受其控股的实体提供服务：',
      list: {
        singapore: '受新加坡共和国实施的金融制裁、出口管制或目标制裁覆盖的国家、地区或人员；',
        un: '受联合国安理会决议实施的制裁覆盖的国家、地区或人员；',
        local: '当地法律全面禁止使用 AI 服务、跨境数据传输或类似互联网服务的地区；',
        upstream: '受上游模型供应商所在司法辖区（如美国 OFAC）全面制裁的地区，包括但不限于克里米亚、顿涅茨克、卢甘斯克、赫尔松、扎波罗热地区，以及朝鲜、伊朗、叙利亚、古巴等——这些地区可能直接影响上游模型供应商对您的服务能力。',
      },
      footer: '如您不确定所在地是否属于受限地区，请通过下文联系方式与我们确认后再注册或充值。',
    },
    upstream: {
      title: '上游模型的地区限制',
      p1: '本服务聚合多家上游 AI 模型供应商（Anthropic、OpenAI、Google 等）。每家上游供应商均有其各自的支持区域政策——上游可能拒绝来自特定地区的请求，或对您施加额外的合规要求。这与 AIInterface 自身的可用性是独立的两层判断。',
      p2: '可能的情况包括：',
      list: {
        ipBlock: '上游模型对某些 IP 段或地区返回错误；',
        rateLimit: '上游模型限制特定地区的注册或调用频率；',
        contentReview: '上游模型基于您的请求内容触发其自身的地理合规审查。',
      },
      p3: '如您因上游限制无法访问某个具体模型，本平台不承担责任，亦不构成本服务整体的不可用。建议在调用前查阅各上游供应商的官方支持区域文档。',
    },
    obligation: {
      title: '您的合规义务',
      body: '无论您来自何处，您都有责任确保您对本服务的使用符合您所在地的法律法规（参见服务条款引言段）。如您所在地禁止或限制您使用本服务、AI 工具或跨境数据传输，您应停止使用，并自行承担因违反所在地法律使用本服务所产生的一切后果。',
    },
    updates: {
      title: '列表更新',
      body: '我们可能基于法律变化、制裁名单更新或上游供应商政策调整修改本政策。重大变更将在站内公告并对未来调用立即生效；既有充值余额将按服务条款的退款政策处理。',
    },
    contact: {
      title: '询问可用性',
      body: '如您对特定地区的可用性有疑问，或您所在地受到本政策限制但您认为存在合理例外（如外交豁免、企业总部位于非受限地区等），请联系：',
      email: '邮箱',
    },
    footer: {
      copyright: '保留所有权利。',
  ...
  serviceTerms: {
    ...
    effectiveDate: '生效日期：2026 年 4 月 29 日',
    intro: {
      p1: '本服务特定条款（"服务特定条款"）针对 AIInterface 提供的特定服务和功能补充服务条款的一般规定。本服务特定条款与服务条款共同构成您与 AIInterface 之间的协议。',
      p2: '如服务条款与本服务特定条款之间存在冲突，仅就所涉具体服务而言，本服务特定条款的规定具有控制效力。本服务特定条款中未定义的术语沿用服务条款中的定义。',
    },
    A: {
      title: 'A. API 使用限制',
      intro: '以下限制适用于所有调用本服务 API 的用户：',
      items: {
        rateLimit: { label: '速率限制', body: '本平台为每个 API Key、每个分组及每个上游模型设定调用频率上限。超出限制的请求会返回 HTTP 429 错误。' },
        quota: { label: '配额', body: '您的可用配额基于账户余额自动核算。余额耗尽时，后续调用将被拒绝直至您完成续费。' },
        cache: { label: '缓存与上游计费', body: '部分上游模型（如 Anthropic Claude）支持 prompt caching。命中缓存的请求按上游折扣价计费，相应折扣会传递给您。' },
        monitoring: { label: '监控', body: '本平台保留监控 API 使用情况的权利，包括识别异常调用模式（如突发高并发、明显的多账户联动、规避限流的尝试等）。' },
      },
    },
    B: {
      title: 'B. 多账号路由与故障切换',
      p1: '本服务的核心能力之一是为同一个上游模型聚合多个供应商账号，并在账号不可用时自动切换。请您理解以下随之而来的影响：',
      items: {
        sharing: { label: '账号共享', body: '您的请求可能由本平台调度的多个上游账号中的任一个承担。这意味着您的调用会与其他用户的调用共享同一上游账号的限流、配额和被封风险。' },
        failover: { label: '故障切换', body: '如某个上游账号被封禁、限流或返回异常，本平台会自动切换到其他可用账号重试。极端情况下，所有备用账号同时失效会导致该模型短期不可用。' },
        opacity: { label: '路由透明度', body: '您不会被告知具体使用了哪个上游账号，本平台对路由策略保留自由裁量权。' },
        nonDiscrimination: { label: '不基于内容', body: '本平台不基于您的请求内容对路由做差异化处理——您的输入和输出不会影响调度选择。' },
      },
    },
    C: {
      title: 'C. API Key 管理',
      items: {
        lifecycle: { label: '创建与撤销', body: '您可以在控制台创建多个 API Key，并随时撤销。撤销后的 Key 立即拒绝新请求；正在进行中的请求仍可能完成。' },
        propagation: { label: '变更生效时延', body: 'API Key 的权限变更（例如所属分组、模型白名单）生效有最长 60 秒的传播时延，请预留充分时间。' },
        rotation: { label: '轮换建议', body: '建议您定期轮换 API Key 并撤销旧 Key。如您怀疑 Key 已泄漏，应立即撤销并通知本平台。' },
      },
    },
    D: {
      title: 'D. 分组与模型白名单',
      items: {
        groupBased: { label: '分组制', body: '本平台基于"分组"（Group）对您可调用的模型进行白名单管理。您所属分组决定了您可调用的模型列表与对应单价。' },
        denied: { label: '未授权调用', body: '调用未在您分组白名单内的模型会返回 HTTP 403 错误。' },
        adminChange: { label: '管理员调整', body: '管理员可调整分组的模型白名单或单价；调整对未来的调用即时生效，对进行中的请求不影响。' },
      },
    },
    E: {
      title: 'E. 计费与赠送额度',
      items: {
        priority: { label: '扣减优先级', body: '当您账户中同时存在赠送额度（来自兑换码、优惠码或活动赠送）和现金充值额度时，赠送额度优先被扣减。' },
        expiry: { label: '赠送额度有效期', body: '赠送额度可能附带有效期，过期未使用的赠送额度将被清零；过期的赠送额度无法恢复。' },
        nonRefundable: { label: '赠送额度不可退款', body: '赠送额度不可申请退款。仅现金充值额度可按服务条款 D 节"退款政策"申请退款。' },
        trial: { label: '试用额度', body: '本平台可能向新注册用户提供试用额度。试用额度受额外限制（如限模型、限调用次数），并不可退款。' },
      },
    },
    F: {
      title: 'F. Beta / 实验性模型',
      p1: '本平台可能将部分模型标记为 Beta 或实验性（"Beta 模型"）。Beta 模型：',
      items: {
        asIs: '按"现状"提供，本平台不就其可用性、稳定性或输出质量作出任何承诺；',
        priceVolatile: '价格、配额可能在不另行通知的情况下调整；',
        sunset: '可能在任何时候被下线、合并到正式服务或永久移除。',
      },
      p2: '您选择调用 Beta 模型即表示您接受上述风险。',
    },
    G: {
      title: 'G. 数据保留与训练政策',
      items: {
        prompts: { label: '请求与响应内容', body: '本平台默认不持久化您的请求体（prompt、消息、附件）和响应内容。仅在调试场景下经您明确同意时才会短暂留存，并尽可能短地保留。' },
        metadata: { label: '元数据与 usage 日志', body: '调用元数据（时间戳、模型 ID、token 数量、API Key 摘要、HTTP 状态码、错误码）会保留至少 90 天用于计费、审计与安全分析。' },
        account: { label: '账户数据', body: '您的账户邮箱、API Key 摘要、充值记录与订单信息会保留至您主动注销账户后 30 天，期间用于税务、争议处理和法律合规。30 天后将匿名化或删除。' },
        legalHold: { label: '法律保留', body: '上述删除时间表受法律义务限制——如本平台收到执法机关或监管机构的合法保留通知，相关数据可能保留更长时间。' },
        noTraining: { label: '不用于训练', body: '本平台不使用您的输入或输出训练任何模型。本平台对上游模型的调用通常通过上游的零留存 / 不训练通道发起；上游模型供应商自身的训练政策由其自身决定，详见上游服务条款。' },
      },
    },
    H: {
      title: 'H. 不提供的服务',
      intro: '为避免误解，明确以下服务不由本平台提供。如您需要这些能力，应直接联系上游模型供应商或其他服务商：',
      items: {
        finetuning: { label: '模型微调（Fine-tuning）', body: '不提供。本平台是聚合网关，不提供模型训练或定制能力。' },
        selfHosted: { label: '私有部署 / 自托管', body: '不提供。本服务仅以多租户云 API 形式提供。' },
        dataPartner: { label: '数据训练合作', body: '不提供。本平台不会以任何形式收购或使用您的数据进行模型训练。' },
        formalSla: { label: '书面 SLA / 可用性补偿', body: '本服务暂不提供正式书面 SLA 或可用性补偿条款。我们尽商业合理努力维持高可用，但不作出具体可用性百分比承诺。如您的业务需要正式 SLA，建议您与上游供应商签订企业协议或自建方案。' },
      },
    },
    I: {
      title: 'I. 修订',
      p1: '本平台可不时更新本服务特定条款以应对功能变更或新出现的运营需要。重大变更将在站内公告，并于公告后 30 天生效；非重大变更（如表述润色、补充示例）发布即生效。您持续使用相应服务即视为接受最新条款。',
    },
    footer: {
      copyright: '保留所有权利。',
      home: '首页',
  ...
  user: {
    payment: {
      ...
      customAmount: '自定义金额',
      amountRange: '金额范围',
      amountTooLow: '最低充值 ¥{min}',
      amountTooHigh: '最高充值 ¥{max}',
      paymentType: '支付方式',
      fee: '手续费',
      noFee: '免手续费',
      payAmount: '实付金额',
      ...
      orderHistory: '最近订单',
      noOrders: '暂无订单记录',
      scanQr: '请使用手机扫描二维码完成支付',
      goToPay: '前往支付',
      polling: '等待支付结果...',
      backToForm: '返回',
      cancelOrder: '取消订单',
      cancelConfirm: '确定要取消这笔订单吗？',
      tooManyPendingOrders: '您有太多待支付的订单，请先完成或取消已有订单',
      paymentSuccess: '充值成功',
      recharging: '充值中',
      paymentFailed: '支付失败',
      ...
      orderExpired: '订单已过期',
      statusUnknown: '未知状态',
      paymentSuccessDesc: '余额已到账，感谢您的充值！',
      rechargingDesc: '支付已确认，正在为您充值余额...',
      paymentFailedDesc: '支付未成功，请重试或联系客服',
      orderCancelledDesc: '订单已取消',
      orderExpiredDesc: '订单已超时，请重新发起支付',
      loadFailed: '加载支付配置失败',
      loadOrdersFailed: '加载订单失败',
      orderCreated: '订单创建成功',
      createFailed: '创建订单失败',
      cancelFailed: '取消订单失败',
      noPaymentMethods: '暂无可用支付方式，请联系管理员配置',
      status: {
        pending: '待支付',
        paid: '已支付',
        recharging: '充值中',
  ...
  admin: {
    ...
    dashboard: {
      ...
      actual: '实际',
      standard: '标准',
      todayUpstreamCost: '今日成本',
      todayProfit: '今日利润',
      totalUpstreamCost: '累计成本',
      totalProfit: '累计利润',
      profitMargin: '利润率',
      revenue: '收入',
      upstreamCost: '成本',
    ...
    users: {
      ...
      // 用户分组配置
      groupConfig: '用户分组配置',
      groupConfigHint: '为用户 {email} 配置专属分组权限',
    ...
    groups: {
      ...
      modelPricing: {
        ...
        actions: '操作',
        addModel: '添加模型',
        emptyHint: '未配置模型定价，将使用系统默认定价。',
        emptyModelWarning: '部分模型名称为空，保存时将被忽略。',
        unprofitableWarning: '部分模型的卖价低于成本价，将导致亏损！',
        delete: '删除'
      },
      mcpXml: {
        title: 'MCP XML 协议注入',
    ...
    payment: {
      configTitle: '支付配置',
      configDescription: '管理支付参数、渠道、套餐与订单统计',
      ordersTitle: '支付订单',
      ordersDescription: '查看和管理所有支付订单',
      ...
      configFields: '配置项',
      limits: '限额规则',
      createProvider: '新建支付实例',
      editProvider: '编辑支付实例',
      providerSaved: '支付实例保存成功',
      deleteProviderConfirm: '确定要删除该支付实例吗？',
      loadProvidersFailed: '加载支付实例失败',
      saveProviderFailed: '保存支付实例失败',
