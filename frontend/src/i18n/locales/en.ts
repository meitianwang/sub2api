export default {
  ...
  home: {
    ...
    hero: {
      title: 'One API key. All AI models.',
      subtitle: 'Claude · GPT · Gemini · {count} models, pay-per-token billing, no subscription required.',
      subtitleFallback: 'Claude · GPT · Gemini · pay-per-token billing, no subscription required.'
    },

    curl: {
      title: 'Make your first call',
      description: 'Use any supported model through one unified API.',
      copy: 'Copy',
      copied: 'Copied'
    },
    ...
    pricing: {
      title: 'Pricing',
      realtimeLink: 'Real-time pricing →',
    ...
    values: {
      routing: 'Multi-account routing with automatic failover.',
      billing: 'Token-level billing — pay only for what you use.',
      compat: 'Drop-in compatible with Claude Code, OpenAI SDK, Gemini CLI.'
    },
  ...
  user: {
    payment: {
      ...
      scanQr: 'Scan the QR code with your phone to complete payment',
      goToPay: 'Go to Pay',
      polling: 'Waiting for payment...',
      backToForm: 'Back',
      cancelOrder: 'Cancel Order',
      cancelConfirm: 'Are you sure you want to cancel this order?',
      tooManyPendingOrders: 'Too many pending orders. Please complete or cancel existing ones first.',
      ...
      paymentSuccessDesc: 'Your balance has been credited. Thank you!',
      rechargingDesc: 'Payment confirmed. Crediting your balance...',
      paymentFailedDesc: 'Payment was not successful. Please try again.',
      orderCancelledDesc: 'This order has been cancelled.',
      orderExpiredDesc: 'This order has expired. Please create a new one.',
      loadFailed: 'Failed to load payment config',
  ...
  admin: {
    ...
    dashboard: {
      ...
      actual: 'Actual',
      standard: 'Standard',
      todayUpstreamCost: 'Today Upstream Cost',
      todayProfit: 'Today Profit',
      totalUpstreamCost: 'Total Upstream Cost',
    ...
    users: {
      ...
      groupConfigHint: 'Configure exclusive group permissions for user {email}',
    ...
    groups: {
      ...
      modelPricing: {
        ...
        actions: 'Actions',
        addModel: 'Add Model',
        emptyHint: 'No model pricing configured. System default pricing will be used.',
        emptyModelWarning: 'Some model names are empty and will be ignored when saving.',
        unprofitableWarning: 'Some models have sell prices lower than cost prices, resulting in losses!',
        delete: 'Delete'
      },
      mcpXml: {
    ...
    // Payment
    payment: {
      configTitle: 'Payment Configuration',
      configDescription: 'Manage payment settings, channels, plans and order statistics',
      ordersTitle: 'Payment Orders',
      ordersDescription: 'View and manage all payment orders',
      ...
      // Config Settings
      configSettings: 'Payment Settings',
      configSaved: 'Configuration saved',
      ...
      deleteProviderConfirm: 'Are you sure you want to delete this provider instance?',
      loadProvidersFailed: 'Failed to load provider instances',
      saveProviderFailed: 'Failed to save provider instance',
      ...
      // Orders
      userIdSearch: 'Search by user ID',
      allStatus: 'All Status',
